                                            ...
                                            <div class="row">
                                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <select class="form-control" id="rAccess" name="rAccess" disabled>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <select class="form-control" id="rBlock" name="rBlock" disabled>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <input class="form-control" type="text" id="rContact" name="rContact">
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <input class="form-control" type="text" id="rAddress" name="rAddress">
                                                        </div>
                                                    </div>
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        if (result.status == "ok")
                        {
                            ...
                            $('#rContact').val(getReqDataUser.user_contact);
                            $('#rEmail').val(getReqDataUser.user_email);
                            $('#rAddress').val(getReqDataUser.user_address);
                        }
                        else
                        {
                            window.location.href = "login.php";
